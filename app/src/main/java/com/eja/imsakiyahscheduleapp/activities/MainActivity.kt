package com.eja.imsakiyahscheduleapp.activities
...
import com.eja.imsakiyahscheduleapp.adapter.MainAdapter
import com.eja.imsakiyahscheduleapp.model.ModelMain
import com.eja.imsakiyahscheduleapp.service.GetAddressIntentService
...
class MainActivity : AppCompatActivity(), MainAdapter.onSelectData {
    ...
    private val dataJSON: Unit
        get() {
            ...
            progressDialog.setMessage("Mohon tunggu...")
            progressDialog.show()
            AndroidNetworking.get("http://api.aladhan.com/v1/hijriCalendarByCity?city=Jakarta&country=Indonesia&method=5&month=09&year=1442")
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONObject(object : JSONObjectRequestListener {
                    override fun onResponse(response: JSONObject) {
